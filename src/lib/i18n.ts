    ...
    resources: {
      en: {
        translation: {
          ...
          kaononaiDescription: `Known as "The faceless one," Kaononai is a bounty hunter who, in exchange for money, seeks people who have done terrible things. His motivations are still a mystery, and his real existence is questioned by the population of Belgadina and Ázuma, who think it is just an urban legend to scare children.`,
      ...
      pt: {
        translation: {
          ...
          kaononaiDescription: `Conhecido como "O sem rosto", Kaononai é um caçador de recompensas que busca, em troca de dinheiro, pessoas que fizeram coisas terríveis. Suas motivações ainda são um mistério, e sua real existência é questionada pela população de Belgadina e Ázuma, que acham que se trata apenas de uma lenda urbana para dar medo em crianças.`,
          ...
          chapters_pt: [
            ...
            {
              id: 5,
              title: "Capítulo - 5: Hatsúi",
              shortTitle: "Hatsúi",
              cover: "/pt/ChapterSection/prePages/Rithual pré pagina cap 5.png",
              aditionalCover: "/pt/ChapterSection/toolTipPages/random6.png",
              description:
                "No seu primeiro dia de aula, Singer conhece Hatsúi, um garoto alegre e bastante animado. Juntos, eles exploram a escola e conhecem outras pessoas, mas, enquanto eles conversam, algo os observa...",
              url: "https://tapas.io/episode/3228757",
            },
          ],
