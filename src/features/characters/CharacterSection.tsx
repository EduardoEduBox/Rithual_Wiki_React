...
const CharacterSection: React.FC = () => {
  ...
  const characters: Characters[] = [
    ...
    new Characters(
      ...
      "Kaononai",
      "??",
      t("kaononaiDescription"),
      "/CharacterSection/profile/Kaononai Profile.png",
      "/CharacterSection/withoutText/Kaononai withoutText.png",
      "/CharacterSection/withText/Kaononai corpo completo.png",
      "rgb(255 222 91)",
      true,
      "lg:h-[102%]"
    ),
  ...
  return (
    <>
      ...
      <section className="relative" id="characterSection">
        ...
        <div
          className={`flex w-full lg:hidden mt-5 ${
        ...
        >
          <div className="flex items-center flex-shrink-0 w-1/3">
            <img
              className="object-cover w-full h-auto rounded-full aspect-square"
        ...
        >
          ...
          <div className="flex flex-col bottom-[40%] min-w-[67rem] absolute -z-10">
            <h1
              ...
              className="font-bold flex justify-center text-[9vw] whitespace-nowrap"
              style={{
                color: characters[indexOfCharacterClicked].colorTheme,
              }}
            >
        ...
        >
          ...
          >
            {characters.map((character: Characters, index) => {
              ...
              return (
                <div className="w-screen lg:w-1/4 lg:h-[85vh] flex items-end" key={character.name}>
                  <img
